...
public class HubController {
    ...
    @DeleteMapping("/{hubId}")
    public ResponseEntity<BaseResponseDto<HubInfoResponseDto>> deleteHub(@PathVariable("hubId") UUID hubId) {
        BaseResponseDto<HubInfoResponseDto> responseDto = hubService.deleteHub(hubId);
